/*
=========== Скрипт нанесения урона по NPC только определённым оружием ===========
Описание:

Данный скрипт работает на Custom NPCs Minecraft 1.12.2. Суть скрипта - нанесение полного урона по NPC только определённым оружием из списка в настройках.
При этом, если не использовать эти оружия, игрок будет наносить на половину меньше урона по этому NPC. Имеется поддержка MineFantasy Reforged оружия/инструментов.
...
// ================== НАСТРОЙКИ ==================
// Различать оружие не по ID, а по NBT тегам - ture/false (сделано только для MineFantasy Reforged)
...
// Основная функция-событие, вызываемая до получения урона NPC
